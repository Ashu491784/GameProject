...
const Register = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden flex flex-col justify-center items-center py-8">
      <video
      ...
      <div className="relative w-full max-w-md bg-gray-800 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl overflow-hidden border border-cyan-500 border-opacity-30 z-10 gaming-login-card mb-8">
        ...
        <div className="px-6 py-5 space-y-3">
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center mb-3">
              ...
              <h1 className="text-2xl font-bold text-white gaming-font">CREATE ACCOUNT</h1>
          ...
          {error && (
            <motion.div
              className="mb-4 p-3 bg-red-900 bg-opacity-70 border border-red-700 rounded-lg text-red-200 text-sm flex items-center gaming-error"
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
            >
          ...
          <form onSubmit={handleSubmitev} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 bg-gray-900 bg-opacity-70 border border-cyan-700 border-opacity-50 rounded-lg text-white placeholder-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all duration-200 gaming-input"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  ref={emailRef}
                  className="w-full px-4 py-2.5 pl-10 bg-gray-900 bg-opacity-70 border border-cyan-700 border-opacity-50 rounded-lg text-white placeholder-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all duration-200 gaming-input"
            ...
            <div className="pt-2">
              <motion.button
                type="submit"
                disabled={isLoading}
                className={`w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-lg text-sm font-semibold text-white transition-all duration-200 gaming-submit-btn ${
            ...
            <p className="text-center text-sm text-gray-300 gaming-text pt-2">
