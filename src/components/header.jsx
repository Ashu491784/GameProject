    ...
    >
      ...
      <div className="flex lg:gap-14 gap-4 items-center">
        <img
          ...
          src="public\images\logoss.png"
          alt="log0-img"
        ></img>

        <div className="hidden md:flex gap-5 items-center">
          <button
            className="h-8 px-6 bg-gradient-to-r from-purple-400 to-indigo-500 rounded-lg font-medium 
      ...
      >
        ...
        <div className="flex flex-col gap-3 w-full mt-4">
          ...
          <button className="bg-gray-500 py-2  rounded">Net Store</button>
        </div>
      </div>
    </header>
  );
